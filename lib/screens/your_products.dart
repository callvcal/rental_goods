...
class _OwnProductsPageState extends State<OwnProductsPage> {
  ...
  List<ProductData> data = [
    ProductData(name: 'Product 1', previousPrice: 40, newPrice: 30, stock: 1, type: 'New', image: 'assets/images/image1.png', availability: 'Available'),
    ProductData(name: 'Product 2', previousPrice: 50, newPrice: 40, stock: 2, type: 'Old', image: 'assets/images/image2.png', availability: 'Not Available'),
    ProductData(name: 'Product 3', previousPrice: 80, newPrice: 70, stock: 5, type: 'New', image: 'assets/images/image3.png', availability: 'Available'),
    ProductData(name: 'Product 4', previousPrice: 90, newPrice: 80, stock: 6, type: 'Old', image: 'assets/images/image3.png', availability: 'Not Available'),
  ];
